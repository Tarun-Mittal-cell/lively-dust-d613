...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lively-dust-d613)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively-dust-d613
```

A live public deployment of this template is available at [https://lively-dust-d613.templates.workers.dev](https://lively-dust-d613.templates.workers.dev)
